...
public enum AiErrorCode implements ErrorCode {
    ...
    DUPLICATE_AI_REQUEST(HttpStatus.TOO_MANY_REQUESTS, "AI_004", "이미 생성 중인 작업이 있습니다. 잠시만 기다려주세요."),
    RATE_LIMIT_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS, "AI_005", "요청이 너무 잦습니다. 5초 후에 다시 시도해주세요."),
    ;
