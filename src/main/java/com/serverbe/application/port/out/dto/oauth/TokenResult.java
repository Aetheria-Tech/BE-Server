...
public record TokenResult(
     ...
     * @param accessToken 액세스 토큰 결과 객체
     * @param refreshToken 리프레시 토큰 결과 객체
     * @param role 사용자 권한
     * @return 생성된 토큰 결과 객체
     */
    public static TokenResult of(AccessTokenResult accessToken, RefreshTokenResult refreshToken, Role role) {
        return new TokenResult(accessToken, refreshToken, role);
    }
}