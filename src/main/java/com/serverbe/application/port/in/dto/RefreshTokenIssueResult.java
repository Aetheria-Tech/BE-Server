...
public record RefreshTokenIssueResult(
    ...
    public static RefreshTokenIssueResult of(String opaqueToken, String name, Instant expiredAt) {
        return new RefreshTokenIssueResult(opaqueToken, name, expiredAt);
    }
}