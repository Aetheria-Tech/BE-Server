...
public interface OAuthClientPort {
     ...
     */
    Mono<OAuthUserInfo> getUserInfo(String code, OAuthProvider provider);
     ...
     */
    Mono<SocialTokenRefreshResponse> refreshSocialToken(OAuthProvider provider, String refreshToken);
