...
public class AddressValidator {
     ...
     * @throws ExternalApiException {@link ExternalApiErrorCode#INVALID_ADDRESS}를 포함하며, 구체적인 위반 사유를 메시지에 담습니다.
     */
    public static void validate(String address) {
        ...
        if (trimmedAddress.length() < 3) {
            throw new ExternalApiException(ExternalApiErrorCode.INVALID_ADDRESS, "주소가 너무 짧습니다. 보다 구체적인 주소를 입력해주세요.");
        }
